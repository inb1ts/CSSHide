...
def init_argparse() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--minify", default=True, action=argparse.BooleanOptionalAction)
...
if __name__ == "__main__":
    ...
    payload_as_random = []
    payload_encoder = CSSPayloadEncoder()
    ...
    css_output = css_generator.generate(payload_as_variables, payload_as_random, args.minify)
